...
def build_container(settings: Settings | None = None) -> ApplicationContainer:
    ...
    dispatcher = RqSessionJobDispatcher(sync_redis, resolved_settings.rq_queue_name)
    return ApplicationContainer(
        ...
        diagram_session_workflow=DiagramSessionWorkflow(session_service, dispatcher),
    )
